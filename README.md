...
Most of what I ship lives in private repos — client platforms, payment flows,
campaign systems, the unglamorous production work that real businesses run on.
What you see here is the part I can share: the tooling and the method. The green
squares undercount the mileage.
